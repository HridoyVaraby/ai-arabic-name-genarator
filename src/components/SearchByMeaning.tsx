    ...
    <form onSubmit={handleSearch} className="space-y-4">
      <div>
        ...
        <div className="mt-1 relative rounded-md shadow-sm">
          <input
            ...
            name="meaning"
            id="meaning"
            className="focus:ring-emerald-500 focus:border-emerald-500 block w-full rounded-lg py-2 px-3 sm:py-3 sm:px-4 text-sm sm:text-sm border border-gray-300 hover:border-emerald-400 transition-colors duration-200"
      ...
      <div className="flex justify-center">
        <button
          ...
          className="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 border border-transparent text-sm sm:text-base font-medium rounded-md shadow-sm text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
        >
          {isLoading ? (
            <>
