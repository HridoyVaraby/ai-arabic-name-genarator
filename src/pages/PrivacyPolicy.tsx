    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6 sm:p-8">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Interpretation and Definitions</h2>
            <h3 className="text-xl font-semibold text-emerald-700 mb-3">Interpretation</h3>
            <p className="text-gray-700 mb-4">
              The words of which the initial letter is capitalized have meanings defined under the following conditions. 
              The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>
            
            <h3 className="text-xl font-semibold text-emerald-700 mb-3">Definitions</h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
              <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Varabit Web Design and Development.</li>
              ...
              <li><strong>Website</strong> refers to Arabic Name Generator, accessible from <a href="https://aiarabicname.netlify.app" className="text-emerald-600 hover:underline">https://aiarabicname.netlify.app</a></li>
              <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
            </ul>
          </section>
          
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Collecting and Using Your Personal Data</h2>
            <h3 className="text-xl font-semibold text-emerald-700 mb-3">Types of Data Collected</h3>
            
            <h4 className="text-lg font-semibold text-emerald-600 mb-2">Personal Data</h4>
            <p className="text-gray-700 mb-4">
            ...
            <h4 className="text-lg font-semibold text-emerald-600 mb-2">Usage Data</h4>
            <p className="text-gray-700 mb-4">
            ...
            <h4 className="text-lg font-semibold text-emerald-600 mb-2">Tracking Technologies and Cookies</h4>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Use of Your Personal Data</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Retention of Your Personal Data</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Transfer of Your Personal Data</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Disclosure of Your Personal Data</h2>
            <h3 className="text-xl font-semibold text-emerald-700 mb-3">Business Transactions</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-emerald-700 mb-3">Law enforcement</h3>
            <p className="text-gray-700 mb-4">
              Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            
            <h3 className="text-xl font-semibold text-emerald-700 mb-3">Other legal requirements</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Security of Your Personal Data</h2>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-emerald-800 mb-4">Links to Other Websites</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>By email: privacy@varabit.com</li>
